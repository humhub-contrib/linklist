...
return [
  ...
  '<strong>Link</strong> list' => '<strong>Link</strong> lijst',
  ...
  'Title' => 'Titel',
  'You can enable the extended validation of links for a space or user.' => 'U kunt de uitgebreide validatie van links inschakelen voor een ruimte of een gebruiker.',
  'You miss the rights to add/edit links!' => 'U hebt niet genoeg rechten om links toe te voegen of aan te passen!',
  'You miss the rights to delete this category!' => 'U hebt niet genoeg rechten om deze categorie te verwijderen!',
  'You miss the rights to delete this link!' => 'U hebt niet genoeg rechten om deze link te verwijderen!',
  'You miss the rights to edit this category!' => 'Je hebt niet genoeg rechten om deze categorie aan te passen!',
  'You miss the rights to edit this link!' => 'U hebt niet genoeg rechten om deze link aan te passen!',
];
