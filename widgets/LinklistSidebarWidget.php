...
class LinklistSidebarWidget extends HWidget {
	...
	public function getContainer() {
		...
		if ($spaceGuid != "") {
			...
			if ($container == null) {
				throw new CHttpException(404, Yii::t('LinklistModule.base', 'Space not found!'));
			}
		} elseif ($userGuid != "") {
			...
			throw new CHttpException(500, Yii::t('LinklistModule.base', 'Could not determine content container!'));
		}
		return $container;
	}
}
