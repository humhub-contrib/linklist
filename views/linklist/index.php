...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        ?>>
        <?= Yii::t('LinklistModule.base', 'There have been no links or categories added to this space yet.') ?> <i class="fa fa-frown-o"></i>
        </div>
                                ...
                                <?php foreach ($links[$category->id] as $link) { ?>
                                    <li class="linklist-link" id="linklist-link_<?= $link->id; ?>"
                                        ...
                                        <div class="linklist-interaction-controls">
                                            <?= humhub\modules\comment\widgets\CommentLink::widget(['object' => $link, 'mode' => 'popup']); ?> &middot;
